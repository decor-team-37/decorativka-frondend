      ...
      <div className='menu__content'>
        <ul className='menu__categorys'>
          <li className='menu__category-item'>
            <button className='menu__category-btn' onClick={() => setIsOpenServices(!isOpenServices)}>
          ...
          <li className='menu__category-item'>
            <button className='menu__category-btn' onClick={() => setIsOpenProducts(!isOpenProducts)}>
              <div className='menu__category-title'>
                <h4 className={classNames(
                  'menu__category-name',
          ...
          <li className='menu__category-item'>
            <div className='menu__category-title'>
              <Link to='/'>
                <h4 className='menu__category-name'>
                  Про нас
                </h4>
              </Link>
            </div>
